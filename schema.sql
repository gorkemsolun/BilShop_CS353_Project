...
values ('0');
insert into User(userID, name, email, password)
values ('10', 'MCK', 'MCK', 'admin');
insert into Business(userID, balance)
values ('10', 4000);
insert into Product(productID, title, price, status, category)
values ('1', 'Murat1', 400, 'notSold', 'Jewelry'),
...
insert into Owns(userID, productID, amount)
values ('10', '1', 5),
    ('10', '2', 5),
    ('10', '3', 5),
    ('10', '4', 5),
